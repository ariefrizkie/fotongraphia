...
export const faq = [
  {
    ...
    5. kirimkan file melalui email, link download, atau wa document`,
  },
  {
    pertanyaan: "Apakah ada jasa desain ?",
    jawaban: `Jika anda belum memiliki file siap cetak kami juga menyediakan jasa desain, harga desain disesuaikan dengan lama waktu desain dan kerumitan desain yang dibikin. konsep desain dan aset yang dibutihkan seperti logo atau foto bisa disiapkan dan dikirim lewat whatsapp`,
  },
  {
    pertanyaan: "Berapa lama proses order ?",
    jawaban: `Proses pengerjaan tergantung dari berapa banyak jumlah pemesanan dan seberapa banyak antrian order. proses order juga tergantung dari kesiapan file yg akan di cetak.`,
  },
  {
    pertanyaan: "Bagaimana cara melakukan pemesanan atau order ?",
    jawaban: `Saat ini pemesanan secara online hanya bisa lewat sosial media atau chat whatsapp ke kontak yang tersedia. Dengan template pemesanan sebagai berikut:<br>
    Nama produk :<br>
    Banyak Pemesanan :<br>
    Spesifikasi Pemesanan :<br>
    Desain / Konsep desain : `,
  },
  {
    pertanyaan: "Bagaimana pembayaran pemesanan secara online ?",
    jawaban: `Pembayaran dapat melalui transfer bank atau melalui dompet digital (E-wallet)`,
  },
  {
    pertanyaan:
      "Bagaimana jika file yg dikirim ternyata ada kesalahan atau kekeliruan ?",
    jawaban: `Revisi desain dapat dilakukan selama proses print atau cetak belum dilakukan. Jika proses cetak sudah berjalan dan perlu ada yg di revisi maka revisi tidak bisa dilakukan lagi, atau jika harus di revisi maka file baru akan di cetak sebanyak jumlah sisa pemesanan dan kerugian ditanggung pemesan.`,
  },
  {
    pertanyaan:
      "Bagaimana saya ingin mengetahui atau melihat hasil cetak sebelum diproses semua?",
    jawaban: `Jika dibutihkan setelah file disetujui atau di acc, maka kami akan coba proses 1 pcs untuk diperlihatkan hasilnya`,
  },
  {
    pertanyaan: "Bagaimana jika hasil tidak sesuai atau ada yg cacat?",
    jawaban: `Jika hasil tidak sesuai, barang pesanan bisa di kembalikan sejumlah barang yg rusak dan akan diganti sesuai kesepakatan, dan batas komplain maksimal 2 hari setelah pesanan diambil`,
  },
  {
    pertanyaan:
      "Bagaimana saat pesanan selesai tetapi belum bisa mengambil pada hari yang sama?",
    jawaban: `Pesanan yg selesai akan di beritahu kepada customer, dan waktu pengambilal maksimal 3 hari, jika lebih dari 3 hari kemudian ada kerusakan barang atau hilang semua bukan tanggung jawab kami`,
  },
];
